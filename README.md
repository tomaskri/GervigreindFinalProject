All the final work was done in the 'onlyOneCity.py' airbnb.ipynb and airbnbNN.ipynb are old files. We changed to .py instead of .ipynb because it was difficult to resolve merge issues in .ipynb. 
